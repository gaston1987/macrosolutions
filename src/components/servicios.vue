  ...
  <div id="servicio">
    ...
    <v-row justify="center" class="mt-10">
      ...
      <v-col sm="12" md="4" lg="3" class="mx-5 mb-10">
        ...
        >
          <v-card-text>
            ...
            <div class="text--primary">
              Estructuración de planes estratégicos que colaboren en la
              correlación entre el flujo de ingresos y las cuentas a pagar de la
              compañía.
            </div>
            <p></p>
          </v-card-text>
        ...
        >
          <v-card-text>
            ...
            <div class="text--primary">
             Optimizar la estructura de capital con el objetivo de financiar
              actividades de acuerdo al flujo de ingresos a generar con la
              inversión y al plazo de recupero de la misma.
            </div>
            <p></p>
          </v-card-text>
          <v-card-actions>
      ...
      <v-col sm="12" md="4" lg="3" class="mx-5 mb-10">
        ...
        >
          <v-card-text>
            <h2 class="text--primary">Comercialización</h2>
            <div class="text--primary">
             Armado de redes de venta y comercialización en todo el país con
              asistencia financiera directa al consumidor final.
            </div>
            <p></p>
          </v-card-text>
          <v-card-actions>
